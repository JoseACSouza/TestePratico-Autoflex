...
export default function ProductList() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10 min-h-screen bg-[#FDFCFB]">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        ...
        <button 
          ...
          className="flex items-center justify-center gap-2 bg-stone-900 text-white px-8 py-4 rounded-xl hover:bg-amber-800 transition-all shadow-xl shadow-stone-900/10 active:scale-95 group shrink-0"
        >
      ...
      <div className="space-y-6">
        {loading && products.length === 0 ? (
          ...
          <div className="text-center py-24 bg-stone-50 rounded-3xl border border-stone-100 flex flex-col items-center">
      ...
      <footer className="mt-20 text-center text-stone-300 text-[10px] uppercase tracking-[0.2em] pb-10">
        Artesano • Sistema de Gestão de Produção
      </footer>
    </div>
  );
}